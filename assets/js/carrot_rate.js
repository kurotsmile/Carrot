        ...
        html+='<div class="row m-0 reviewrow p-3 px-0 border-bottom">';
            ...
            html+='<div class="col-md-1 align-items-center col-1 rcolm" role="button" onclick="carrot.user.show_info_mini(\''+user.id+'\',\''+user.lang+'\')">';
                ...
                if(comment.user!=null){
                    ...
                    if(url_avatar_user_field=="") url_avatar_user_field=carrot.url()+'/images/avatar_default.png';
    ...
    box_qr(){
        ...
        html+='<div class="about row p-2 py-3 bg-white mt-4 shadow-sm">';
            ...
            html+='<div class="col-md-9">';
                ...
                html+='<button class="btn btn-success mt-2" onclick="copy_txt_tag(\'link_qr\');carrot.msg("Copied!");"><i class="fa-solid fa-copy"></i> <l class="lang" key_lang="copy">Copy</l></button>';
            html+='</div>';
        html+='</div>';
        return html;
    }
