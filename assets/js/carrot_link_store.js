    ...
    box_qrdoce(){
        ...
        html+='<div class="about row p-2 py-3 bg-white mt-4 shadow-sm">';
            ...
            html+='<div class="col-md-9">';
                ...
                html+='<div class="fs-9"><i class="fa-solid fa-link"></i> <b>Link</b> : <span id="link_qr">'+window.location.href+'</span></div>';
                html+='<button class="btn btn-success mt-2" onclick="copy_txt_tag(\'link_qr\')"><i class="fa-solid fa-copy"></i> Copy</button>';
            html+='</div>';
        html+='</div>';
        return html;
    }
